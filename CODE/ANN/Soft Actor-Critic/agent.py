...
class Agent():
    ...
    def __init__(self, alpha=0.0003, beta=0.0003, input_dims=[8],
        ...
        # min evaluation of critics is chosen to mitigate overestimation bias
        self.critic_1 = CriticNetwork(beta, input_dims, n_actions=n_actions,
                    name='critic_1')
        self.critic_2 = CriticNetwork(beta, input_dims, n_actions=n_actions,
                    name='critic_2')
        # value function used to speed convergence
        self.value = ValueNetwork(beta, input_dims, name='value')
        # value function with exponential moving average of weights
    ...
    # store tuples in replay buffer
    def remember(self, state, action, reward, new_state, done):
        self.memory.store_transition(state, action, reward, new_state, done)

    # updates target_value network's parameters with EWMA 
